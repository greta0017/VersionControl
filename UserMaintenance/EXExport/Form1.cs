...
namespace EXExport
{
    public partial class Form1 : Form
    {
        ...
        void CreateTable()
        {
            ...
            object[,] values = new object[li.Count, headers.Length];
            ...
            xlSheet.get_Range(  //range-terület visszakapása (bal felső saroktól jobb alsóig)
             GetCell(2, 1), //excel sor,oszlop 2.1
             GetCell(1 + values.GetLength(0), values.GetLength(1))
             ).Value2 = values; //kövi órán átbeszélni
